...
import CreateBootcamp from "./pages/create-bootcamp";
...
import GraduationProcessing from "./pages/graduation-processing";
import AttendeeView from "./pages/attendee-view";
