    ...
    <div className="space-y-8">
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex-1">
          <h1 className="text-3xl font-bold text-gray-900">Attendee Profile</h1>
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        <div className="flex items-center gap-4">
          ...
          <div className="flex-1">
            ...
            <p className="text-gray-600">{attendeeAddress}</p>
          </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <p className="text-sm font-medium text-gray-600">Score Rate</p>
              {/* <p className="text-2xl font-bold text-gray-900">
                {scorePercentage}%
              </p> */}
            </div>
              ...
              <div className="grid grid-cols-4 gap-2">
                {weeks.map((week) => (
                  <div key={week} className="text-center">
                    <div className="text-xs text-gray-600 mb-1">W{week}</div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="space-y-3">
            <div className="flex items-center gap-2">
              ...
              <span className="font-medium">Minimum Attendance (25%)</span>
            </div>
          ...
          <div className="space-y-3">
            <div className="flex items-center gap-2">
              ...
              <span className="font-medium">Graduate Requirements</span>
            </div>
            <p className="text-sm text-gray-600 ml-7">
          ...
          <div className="space-y-3">
            <div className="flex items-center gap-2">
              ...
              <span className="font-medium">Distinction Requirements</span>
            </div>
            <p className="text-sm text-gray-600 ml-7">
